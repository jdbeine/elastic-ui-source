...
`);
  ...
  formPrefixSuffixSource = _.escape(
`<md-input-container>
  <span mdPrefix>+1 &nbsp;</span>
...
`);
  ...
  formCheckboxThemingSource = _.escape(
...
`);
  ...
  formSlideToggleSource = _.escape(
